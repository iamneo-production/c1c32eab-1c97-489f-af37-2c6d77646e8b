...
(async () => {
    ...
    try{
    await page.goto('https://8081-dcefcaebbecaeefecebabbbabbcbefaaacbdaf.project.examly.io/login');
...
//super-admin workflow testcase
  (async () => {
    ...
    const page = await browser.newPage();
    try {
      await page.goto('https://8081-dcefcaebbecaeefecebabbbabbcbefaaacbdaf.project.examly.io/superadmin/login');
    await page.setViewport({
      width:1200,
      height:800,
    })
 ...
 //checking Authentication
  (async () => {
    ...
    try {
      await page.goto('https://8081-dcefcaebbecaeefecebabbbabbcbefaaacbdaf.project.examly.io/user/dashboard');
      await page.setViewport({
        width:1200,
        height:800,
      })
